...
#
#   /spec/fixtures/responses/whois.comlaude.com/status_available.expected
#
...
describe Whois::Record::Parser::WhoisComlaudeCom, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.comlaude.com/status_available.txt")
